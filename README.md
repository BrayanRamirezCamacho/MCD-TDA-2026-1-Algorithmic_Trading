...
El objetivo del proyecto, además de predecir precios, es **construir una base para estrategias de trading algorítmico con TDA**.
...
- Plataforma inicial para integración con Freqtrade
...
- Análisis clásico de series de tiempo (ARIMA, SARIMA, ARIMAX)
